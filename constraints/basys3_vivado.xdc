...
# =============================================================================
# Matches tpu_top_wrapper.sv which uses individual port names (not bus notation)
# to avoid nextpnr-xilinx double-bracket bug
# =============================================================================
...
# =============================================================================
# RESET (active low) - SW15 on Basys3
# =============================================================================
...
# uart_tx (FPGA transmits to PC) → A18
...
# uart_rx (FPGA receives from PC) → B18
set_property LOC B18 [get_ports uart_rx]
...
# =============================================================================
# SWITCHES (SW0-SW14, SW15 is rst_n)
# =============================================================================
