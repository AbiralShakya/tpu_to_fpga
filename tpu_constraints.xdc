...
# Status LEDs (Basys3)
set_property -dict {PACKAGE_PIN U16 IOSTANDARD LVCMOS33} [get_ports tpu_busy]
set_property -dict {PACKAGE_PIN E19 IOSTANDARD LVCMOS33} [get_ports tpu_done]
set_property -dict {PACKAGE_PIN U19 IOSTANDARD LVCMOS33} [get_ports hazard_detected]
set_property -dict {PACKAGE_PIN V19 IOSTANDARD LVCMOS33} [get_ports pipeline_stage[0]]
set_property -dict {PACKAGE_PIN W18 IOSTANDARD LVCMOS33} [get_ports pipeline_stage[1]]
